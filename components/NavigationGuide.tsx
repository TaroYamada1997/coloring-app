...
import { X, ChevronLeft, Palette, Download, RotateCcw, ZoomIn, Move, Hand } from 'lucide-react';
...
const NavigationGuide: React.FC<NavigationGuideProps> = ({ isOpen, onClose }) => {
      ...
      <div className="bg-white rounded-lg w-full max-w-md p-6 relative">
        ...
        <div className="w-full h-1 bg-gray-200 rounded-full mb-6 mt-6">
          <div 
            ...
            style={{ width: `${(currentStep / (guideSteps.length - 1)) * 100}%` }}
          ></div>
        </div>
        ...
        <div className="flex justify-between">
          <button
            ...
            className={`px-4 py-2 rounded-lg ${
              currentStep === 0 ? 'text-gray-400 cursor-not-allowed' : 'text-blue-500'
            }`}
